...
<div>
    <img width="800" src="https://user-images.githubusercontent.com/73386460/115674125-4e54eb80-a388-11eb-8c72-201dbb0bc843.JPG">
</div>
...
-- buyer INSERT
INSERT INTO buyer VALUES ('ok1231','권오민','010-1234-2345','인천광역시 연수구 송도동');
INSERT INTO buyer VALUES ('rabbit777','권희성','010-1234-2346','경기도 부천시 소사구 옥길동');
INSERT INTO buyer VALUES ('wonder486','김민건','010-1234-2347','인천광역시 남동구 구월1동');
INSERT INTO buyer VALUES ('ilovecats2','김성호','010-1234-2348','경기도 시흥시 정왕3동');
INSERT INTO buyer VALUES ('gajagib98','조윤혜','010-1234-2349','경기도 안산시 단원구 고잔동');
INSERT INTO buyer VALUES ('imangel1234','김재웅','010-1234-2350','경기도 안산시 상록구 본오3동');
INSERT INTO buyer VALUES ('basketballs2','김준형','010-1234-2351','강원도 철원군 김화읍');
INSERT INTO buyer VALUES ('waterisbest234','김창훈','010-1234-2352','경기도 안양시 동안구 달안동');
INSERT INTO buyer VALUES ('loveletter','양호준','010-1234-2353','경기도 분당구 백현동');

-- seller INSERT
INSERT INTO seller VALUES ('yoons1234','최지수','010-1235-7896','충청남도 공주시 공주읍');
INSERT INTO seller VALUES ('gibgagopa','장문희','010-1235-7897','강원도 원주시 지정면');
INSERT INTO seller VALUES ('jordansarang','염아정','010-1235-7898','충청북도 충주시 칠금동');
INSERT INTO seller VALUES ('ename7535','김연지','010-1235-7895','전라남도 강진군 강진읍');
INSERT INTO seller VALUES ('real-jorden','박민영','010-1235-7894','제주특별시 제주시 애월읍');
INSERT INTO seller VALUES ('apple342','고은비','010-1235-7893','전라북도 고창군 고창읍');
INSERT INTO seller VALUES ('baegopa55','이정민','010-1235-7892','경상남도 창원시 가포동');
INSERT INTO seller VALUES ('jordanwant','차왕현','010-1235-7891','부산광역시 사직구 사직동');
INSERT INTO seller VALUES ('noniwa','최태열','010-1235-7890','경기도 성남시 수정구 태평동');
...
각 테이블 간 매핑에 있어서 관계도를 생각하지 않고 아이디어를 기반으로 생각하고 구상하다 보니 테이블 매핑이 복잡해져서 erd diagram을 구성하는 내내 고민하고 힘들었던 것 같습니다. 또한 pk와 fk를 정확히 정의하지 못해서 고민하게 되었고, SECONDARY TABLES를 사용하였지만 결국 성공하지 못해 아쉬웠습니다.
